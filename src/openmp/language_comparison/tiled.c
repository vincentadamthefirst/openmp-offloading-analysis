...
int main() {
    ...
    printf("Performing %d repetitions on %dx%d matrices with tile size %d.\n", REPETITIONS, MATRIX_SIZE, MATRIX_SIZE, TILE_SIZE);
    ...
    printf("Average execution time = %.3f ms (%.3f GFLOP/s)\n", meanExecTime, gflops);
